...
def get_args_ant():
    ...
    parser.add_argument('--n-epochs', type=int, default=40000, help='the number of epochs to train the agent')
    parser.add_argument('--n-batches', type=int, default=200, help='the times to update the network')
    parser.add_argument('--seed', type=int, default=798, help='random seed')
    ...
    parser.add_argument('--buffer-size', type=int, default=int(8e6), help='the size of the buffer')
    ...
    parser.add_argument('--resume-epoch', type=int, default=6600, help='resume epoch')
    parser.add_argument('--resume-path', type=str, default='saved_models/AntMazeS-v1_Jan11_06-51-15', help='resume path')
    # antmazes:939 5700, 'saved_models/AntMazeS-v1_Jan11_06-55-44', cuda:2
    # antmazes:24 6600, 'saved_models/AntMazeS-v1_Jan11_06-51-15', cuda:3

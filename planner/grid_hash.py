...
'''
Grid hashing class, recording count of grids
'''
class GridHashing(object):
    ...
    def query_hash(self, obss):
        ...
        '''
        about "why taking min value" here
        single hashmap actually has risk of hash collapse
        so we use multi-head hash code, if single key collapses, other keys may be not.
        so taking 'min' operation can effectively avoid hash key collapse
        '''

...
task_types = ['Maze', 'Maze1', 'Push', 'Fall', 'Block', 'BlockMaze', 'MazeS', 'MazeW']
...
for name_t in all_name:
    # episode length
    if name_t == "AntMaze" or name_t == "AntMazeS" or name_t == "AntMazeW":
        max_timestep = 1000
    else:
        max_timestep = 500
...
register(
    id="HalfCheetahHurdle-v0",
    entry_point="goal_env.mujoco.half_cheetah_hurdle_env:HalfCheetahHurdleEnv",
